    ...
    <div class="col-xs-12" style="padding:0;">
        ...
        <div class="list-group">
            <a href="{{ route('user.email') }}" class="list-group-item">
                邮箱: {{ Auth::user()->email }}
                <span style="position:absolute; right: 20px;">{{ Auth::user()->email_status?'已验证':'未验证' }} <i class="fa fa-angle-right" style="margin-left: 5px"></i></span>
            </a>
            ...
            <a class="list-group-item" href="{{ route("user.address.index") }}">地址信息</a>
        </div>
    </div>
@stop
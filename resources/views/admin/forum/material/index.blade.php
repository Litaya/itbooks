@extends('admin.forum.layouts.layout')
...
@section('forum-content')
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <button class="btn btn-success btn-sm" onclick="syncNews('{{ route('admin.forum.material.sync') }}')" id="btn-sync" style="position: absolute; right: 10px;">同步列表</button>
        </div>
    </div>
    ...
    <div class="row">
        <hr>
        <form action="{{ route('admin.forum.material.index') }}" class="form-horizontal" method="get">
    ...
    @if(!empty($search))
        <div class="row" style="margin-bottom: 20px;">
            <p style="font-size: 14px; color: #aaaaaa">
                当前搜索内容：{{ $search }}&nbsp;&nbsp;&nbsp;&nbsp;
                <a href="{{ route("admin.forum.material.index") }}">清空搜索</a>
            </p>
        </div>
    @else
                    ...
                    <span  style="position: absolute;right: 10px;">
                        @if($material->display == 1)
                            <a href="javascript:void(0)"
                               onclick="set_display('{{ route("admin.forum.material.set_display",$material->id) }}',2)">
                            <small><i class="fa fa-cog"></i> 设为微信文章</small>
                        </a>
                        @elseif($material->display == 2)
                            <a href="javascript:void(0)"
                               onclick="set_display('{{ route("admin.forum.material.set_display",$material->id) }}',1)">
                            <small><i class="fa fa-cog"></i> 设为系统文章</small>
                        </a>
                        @endif
                        &nbsp;&nbsp;
                        <small><a href="javascript:void(0)" style="color:red"
                                  onclick="drop_material('{{ route("admin.forum.material.drop",$material->id) }}')"><i class="fa fa-times"></i> 删除文章</a></small>
                    </span>
                </p>
